...
function MemberCheckPassword() {
  ...
  return (
    <div>
        ...
        <BlockButton label={submittingStatus===AsyncStatus.SUBITTING? "확인 중":"확인"} onClick={doCheckPassword} styleName="primary" disabled={submittingStatus===AsyncStatus.SUBITTING} />
    </div>
  )
}
